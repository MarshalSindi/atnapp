...
<div class="container">
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-md-5 justify-content-start">
            <div class="card">
                <div class="card-body">
                    <h4 class="text-center">Rapport Site</h4>
                    <ol>
                        <li>Niveau Cuve > 200L</li>
                        <li>Niveau Cuve < 200L</li>
                        <li>Niveau Cuve < 180L</li>
                    </ol>
                </div>
            </div>
        </div>
